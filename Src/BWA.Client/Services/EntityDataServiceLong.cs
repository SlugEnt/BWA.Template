...
public class EntityDataServiceLong<TEntityLong> : EntityDataService<TEntityLong>, IEntityRepositoryE2Long<TEntityLong>
...

{
    ...
    public EntityDataServiceLong(HttpClient httpClient,
