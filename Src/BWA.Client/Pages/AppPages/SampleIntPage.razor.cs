...
using Daborg69.StockTrader.Entities.FluentValidators;
...
/// </summary>
public partial class SampleIntPage : AbstractE2ComponentInt<SampleInt>
{

    private List<SampleInt> _entities;
    SampleIntFluentValidator _validator = new SampleIntFluentValidator();


    /// <summary>
    /// Constructor.  Sets APIName to be called.
    /// </summary>
    public SampleIntPage() : base("Sample Integer", "Sample Integer")
    {
        _apiName = "SampleInts";
    }
    ...
    {
        Result<List<SampleInt>> loadResult = await _entityLookupService.GetAllAsync(true, true);
    ...
    protected async Task StartNormalEditOfRecord(SampleInt entity)
    {
