...
public abstract class AbstractCRUDComponent : ComponentBase
{
    ...
    protected string _entitySingluarName = "";
    protected string _entityPluralName = "";
    ...
    public AbstractCRUDComponent(string entitySingluarSinglurName,
                                 string entityPluralName,
                                 string returnToPage)
    {
        _entitySingluarName = entitySingluarSinglurName;
        _entityPluralName = entityPluralName;
    ...
    protected virtual void SetCreateMode()
    {
        ResetModes();
        _isCreateMode = true;
        _pageTitle = "Create " + _entitySingluarName;
    }
    ...
    protected virtual async Task SetEditMode()
    {
        ...
        _pageTitle = "Edit " + _entitySingluarName;
    ...
    protected virtual void SetDeleteMode()
    {
        ...
        _isDeleteMode = true;
        _isReadOnly = true;
        _pageTitle = "Confirm Deletion of " + _entitySingluarName;
    }
    ...
    protected virtual void SetViewMode()
    {
        ...
        _isViewOnly = true;
        _isReadOnly = true;
        _pageTitle = "View " + _entitySingluarName;
    }
