...
public class EntityControllerLong<TEntityLong> : EntityControllerBase<TEntityLong>, IEntityControllerLong<TEntityLong>
    where TEntityLong : AbstractEntityLong, IEntityLong, new()
{
    ...
    public EntityControllerLong(ILogger logger,
                               AppDbContext db,
                               IEntityRepositoryE2Long<TEntityLong> apiEntity,
    ...
    public virtual async Task<ActionResult<TEntityLong?>> GetById(long id)
    {
        try
        {
            ...
            AppProblemObjectResult problemResult = CheckAndValidateIdAndChangedById(id,
                                                                                    1,
                                                                                    nameof(EntityControllerLong<TEntityLong>),
                                                                                    nameof(GetById));
            if (problemResult != null)
                return problemResult;


            Result<TEntityLong?> result = await ((IEntityRepositoryE2Long<TEntityLong>)ApiEntity).GetByIdAsync(id);
            if (result.IsFailed)
        ...
        {
            return ReturnWithProblemFromException(nameof(EntityControllerLong<TEntityLong>),
                                                  nameof(GetById),
                                                  null,
                                                  ex,
    ...
    [ProducesResponseType(StatusCodes.Status400BadRequest)]
    [ProducesResponseType(StatusCodes.Status500InternalServerError)]
    public virtual async Task<ActionResult<TEntityLong?>> GetByIdAnyActivationStatus(long id)
    {
        try
        {
            ...
            Result<TEntityLong?> result = await ((IEntityRepositoryE2Long<TEntityLong>)ApiEntity).GetByIdAnyStatusAsync(id);
            if (result.IsFailed)
                return FailedToFindEntityError(result,
                                               id.ToString(),
                                               nameof(EntityControllerLong<TEntityLong>),
                                                        ...
                                                        int by)
    {
        try
        {
            ...
            Result<TEntityLong?> result = await ((IEntityRepositoryE2Long<TEntityLong>)ApiEntity).DeleteAsync(id, by);
            if (result.IsFailed)
            {
                ...
                return ReturnWithProblemFromResult(nameof(EntityControllerLong<TEntityLong>),
                                                   nameof(DeleteAsync),
                                                   null,
                                                   resultFailed,
                                                   StatusCodes.Status500InternalServerError);
    ...
    [ProducesResponseType(StatusCodes.Status400BadRequest)]
    [ProducesResponseType(StatusCodes.Status500InternalServerError)]
    public virtual async Task<ActionResult> DeactivateAsync(long id,
                                                            int changedByPersonId)
    {
        try
        {
            ...
            Result<TEntityLong> result = await ((IEntityRepositoryE2Long<TEntityLong>)ApiEntity).DeActivateAsync(id, changedByPersonId);
            if (result.IsFailed)
            {
    ...
    [ProducesResponseType(StatusCodes.Status400BadRequest)]
    [ProducesResponseType(StatusCodes.Status500InternalServerError)]
    public virtual async Task<ActionResult> ActivateAsync(long id,
                                                          int by)
    {
        try
        {
            ...
            Result<TEntityLong> result = await ((IEntityRepositoryE2Long<TEntityLong>)ApiEntity).ActivateAsync(id, by);
            if (result.IsFailed)
            {
    ...
    /// <returns></returns>
    protected override Result ValidateAddNew(TEntityLong entity)
    {
        if (entity.Id <0 )
    ...
    protected AppProblemObjectResult CheckAndValidateIdAndChangedById(long id,
                                                                      int changedById,
                                                                      string methodName,
                                                                      string className)
    {
