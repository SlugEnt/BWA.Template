...
public interface IEntityRepositoryE2Guid<TEntityGuid> : IEntityRepositoryE2<TEntityGuid>
...

{
    ...
    /// <param name="id"></param>
    /// <returns></returns>
    public Task<Result<TEntityGuid?>> GetByIdAsync(Guid id);
    ...
    /// <param name="id"></param>
    /// <returns></returns>
    public Task<Result<TEntityGuid?>> GetByIdAnyStatusAsync(Guid id);
